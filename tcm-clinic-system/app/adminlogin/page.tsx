            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-sm rounded-xl border border-sky-100 bg-white p-6 shadow-md space-y-6">
                    <div className="space-y-2 text-center">
                        <h1 className="text-2xl font-bold tracking-tight text-sky-900">Admin Login</h1>
                        <p className="text-sm text-sky-600">เข้าสู่ระบบสำหรับเจ้าหน้าที่และผู้ดูแลระบบ</p>
                    </div>

                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="username" className="text-sky-900">ชื่อผู้ใช้งาน หรือ อีเมล</Label>
                            <Input
                                id="username"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="password" className="text-sky-900">รหัสผ่าน</Label>
                            <Input
                                id="password"
                                type="password"
